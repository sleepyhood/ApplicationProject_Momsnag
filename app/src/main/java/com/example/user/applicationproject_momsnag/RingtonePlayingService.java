        ...
        if (!this.isRunning && startId == 1) {
            ...
            if (whale_sound_choice == 0) {
                ...
                if (whale_number == 1) {
                    ...
                    media_song = MediaPlayer.create(this, R.raw.killerwhale_offshore);                    // start the ringtone
                    media_song.start();
                }/*
                ...
                else if(whale_number == 14){
                    media_song = MediaPlayer.create(this, R.raw.abcd);
                    media_song.start();
                }
                else if(whale_number == 15) {
                    media_song = MediaPlayer.create(this, R.raw.abcd);
                    media_song.start();
                }*/
            ...
            else if (whale_sound_choice == 14) {
                media_song = MediaPlayer.create(this, R.raw.abcd);
                media_song.start();
            }
            else if(whale_sound_choice == 15) {
                media_song = MediaPlayer.create(this, R.raw.abcd);
                media_song.start();
            }
*/
